...
class AddBook(Toplevel):
    def __init__(self):
        ...
        heading = Label(self.topFrame,text='Add Book',font='Arial 12 bold',fg='#003f8a',bg='white')
        ...
        self.lbl_page = Label(self.bottomFrame, text='Page Size:', font='arial 15 bold', fg='white', bg='#fcc324')
    ...
    def addBook(self):
        ...
        if(name and author and page and language !=""):
            try:
                query = "INSERT INTO 'books'(bookname,bookauthor,bookpage,booklanguage) VALUES(?,?,?,?)"
